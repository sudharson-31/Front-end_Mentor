            ...
            <div className="content-box">
                ...
                <div id="profile">
                    <span id="profile-image-container">
                        <img id="profile-image" src={process.env.PUBLIC_URL + "/images/avatar-michelle.jpg"} alt="profile-picture"></img>
                    </span>
                    <div id="details">
                        <span id="name">Michelle Appleton</span>
                        <span id="date">28 Jun 2020</span>
                    </div>
                    <span id="share-image-container">
                        <img id="share-image" src={process.env.PUBLIC_URL + "/images/icon-share.svg"} alt="share"></img>
                    </span>
                </div>
            </div>
        </div>
